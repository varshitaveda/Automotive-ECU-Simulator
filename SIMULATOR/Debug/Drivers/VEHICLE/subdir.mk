...
C_SRCS += \
../Drivers/VEHICLE/vehicle.c 

OBJS += \
./Drivers/VEHICLE/vehicle.o 

C_DEPS += \
./Drivers/VEHICLE/vehicle.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/VEHICLE/%.o Drivers/VEHICLE/%.su Drivers/VEHICLE/%.cyclo: ../Drivers/VEHICLE/%.c Drivers/VEHICLE/subdir.mk
...
clean: clean-Drivers-2f-VEHICLE

clean-Drivers-2f-VEHICLE:
	-$(RM) ./Drivers/VEHICLE/vehicle.cyclo ./Drivers/VEHICLE/vehicle.d ./Drivers/VEHICLE/vehicle.o ./Drivers/VEHICLE/vehicle.su

.PHONY: clean-Drivers-2f-VEHICLE
